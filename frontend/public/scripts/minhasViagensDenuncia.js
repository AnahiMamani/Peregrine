document.addEventListener('DOMContentLoaded', () => {
    ...
    const btnDenunciar = document.getElementById('denuncia');
    ...
    btnDenunciar.addEventListener('click', () => {
        ...
        overlay.innerHTML = `
            <div class="confirm-box">
                <h4>Fazer denúncia?</h4>
                <div class="confirm-buttons">
                    <button class="btn btn-secondary btn-confirmar-nao">Não, quero voltar</button>
                    <button class="btn btn-primary btn-confirmar-sim">Sim, denunciar</button>
                </div>
            </div>
        `;
        ...
        overlay.querySelector('.btn-confirmar-sim').addEventListener('click', () => {
            window.location.href = '/perfil/minhas-viagens-concluidas/denuncia-concluida';  
        });
    });
});
